defmodule Axon do
  ...
  See `Optimus.Updates` and `Axon.Loop` for a more in-depth treatment of
  ...
  in code here:
      ...
      model
      |> Axon.Loop.trainer(:categorical_cross_entropy, Optimus.Optimizers.adam(0.005))
  ...
  fine tune them specifically for your application:
      ...
      model
      |> Axon.Loop.trainer(:categorical_cross_entropy, Optimus.Optimizers.adam(0.0005))
      |> Axon.Loop.run(data, epochs: 10)
