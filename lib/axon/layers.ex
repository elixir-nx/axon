defmodule Axon.Layers do
  ...
  ### One-dimensional convolution
      ...
      #Nx.Tensor<
        ...
        [
          [
            [-0.24591798, 3.080017],
            [-0.17049128, 0.60290253],
            [0.9496373, 2.8051996]
          ],
          [
            [0.78855145, -3.0088954],
            [0.96772015, -0.49842283],
            [2.2071624, -0.35342824]
          ]
        ]
      >
  ...
  *Note: This layer is currently implemented as a fractionally strided
  ...
  ## Examples
      ...
      iex> t = Nx.tensor([[
      ...> [0.0515, -0.7042999863624573, -0.32899999618530273],
      ...> [-0.37130001187324524, 1.6192, -0.11829999834299088],
      ...> [0.7099999785423279, 0.7283, -0.18639999628067017]]], type: {:f, 32})
  ...
  ## Examples
      ...
      ...>  [0.9802, 0.0978, 0.5334],
      ...>  [0.698, 0.9241, 0.2348],
      ...>  [0.3193, 0.4225, 0.7866],
      ...>  [0.5519, 0.5663, 0.2056],
      ...>  [0.1899, 0.9311, 0.8356],
