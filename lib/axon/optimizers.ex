defmodule Axon.Optimizers do
  ...
  """
  @deprecated "Use Optimus.Optimizers.adabelief/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.adagrad/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.adam/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.adamw/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.lamb/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.noisy_sgd/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.radam/2 instead"
  ...
  ## Options
    ...
    * `:eps` - numerical stability term. Defaults to `1.0e-8`
  """
  @deprecated "Use Optimus.Optimizers.rmsprop/2 instead"
  ...
  ## Options
    ...
    * `:nesterov` - whether or not to use nesterov momentum. Defaults to `false`
  """
  @deprecated "Use Optimus.Optimizers.sgd/2 instead"
  ...
  """
  @deprecated "Use Optimus.Optimizers.yogi/2 instead"
