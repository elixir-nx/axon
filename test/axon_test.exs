    ...
    test "works with rnns" do
      ...
      assert inspect(out_sequence) == """
             ...
             ==============================================================================================================================================
              ...
              lstm ( lstm["input_0"] )                  {{{nil, 1, 64}, {nil, 1, 64}}, {nil, 32, 64}}   p=f32 c=f32 o=f32   19200        76800 bytes
              lstm_output_sequence ( custom["lstm"] )   {nil, 32, 64}                                   p=f32 c=f32 o=f32   0            0 bytes
             ----------------------------------------------------------------------------------------------------------------------------------------------
             """
    end

    test "works with atom names" do
      model =
        Axon.input({nil, 784}, name: :input)
        |> Axon.dense(128, name: :dense1)
        |> Axon.dense(10, name: :dense2)
      ...
      {_, out_sequence} = Axon.input({nil, 32, 10}) |> Axon.gru(64, name: :gru)
      ...
      assert inspect(out_sequence) == """
             ...
             =============================================================================================================================
              input_0 ( input )                      {nil, 32, 10}                     p=f32 c=f32 o=f32   0            0 bytes
              gru ( gru["input_0"] )                 {{{nil, 1, 64}}, {nil, 32, 64}}   p=f32 c=f32 o=f32   14464        57856 bytes
              gru_output_sequence ( custom[:gru] )   {nil, 32, 64}                     p=f32 c=f32 o=f32   0            0 bytes
             -----------------------------------------------------------------------------------------------------------------------------
             """
    end
  end
